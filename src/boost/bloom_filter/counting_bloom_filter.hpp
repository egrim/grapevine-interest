...
template<typename T, size_t NumBins, size_t BitsPerBin = 4,
...
public:
    ...
    typedef counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block> this_type;
...
public:
    ...
    template<typename _T, size_t _Bins, size_t _BitsPerBin, typename _HashFns,
            typename _Block>
    friend bool
    operator==(
            const counting_bloom_filter<_T, _Bins, _BitsPerBin, _HashFns, _Block>& lhs
            ,
            const counting_bloom_filter<_T, _Bins, _BitsPerBin, _HashFns, _Block>& rhs);
...
template<class T, size_t NumBins, size_t BitsPerBin, class HashFunctions,
        typename Block>
void swap(
        counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& lhs
        ,
        counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& rhs)
...
template<class T, size_t NumBins, size_t BitsPerBin, class HashFunctions,
        typename Block>
bool operator==(
        const counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& lhs
        ,
        const counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& rhs) {
