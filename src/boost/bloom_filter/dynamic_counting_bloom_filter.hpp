...
template<typename T, size_t BitsPerBin = 4, class HashFunctions = mpl::vector<
        boost_hash<T> >, typename Block = size_t,
...
public:
    ...
    typedef dynamic_counting_bloom_filter<T, BitsPerBin, HashFunctions, Block,
            Allocator> this_type;
...
public:
    ...
    template<typename _T, size_t _BitsPerBin, typename _HashFns,
            typename _Block, typename _Allocator>
    friend bool
    operator==(
            const dynamic_counting_bloom_filter<_T, _BitsPerBin, _HashFns,
                    _Block, _Allocator>& lhs
            ,
            const dynamic_counting_bloom_filter<_T, _BitsPerBin, _HashFns,
                    _Block, _Allocator>& rhs);
...
template<class T, size_t BitsPerBin, class HashFunctions, typename Block,
        typename Allocator>
void swap(
        dynamic_counting_bloom_filter<T, BitsPerBin, HashFunctions, Block,
                Allocator>& lhs
        ,
        dynamic_counting_bloom_filter<T, BitsPerBin, HashFunctions, Block,
                Allocator>& rhs)
...
template<class T, size_t BitsPerBin, class HashFunctions, typename Block,
        typename Allocator>
bool operator==(
        const dynamic_counting_bloom_filter<T, BitsPerBin, HashFunctions, Block,
                Allocator>& lhs
        ,
        const dynamic_counting_bloom_filter<T, BitsPerBin, HashFunctions, Block,
                Allocator>& rhs) {
