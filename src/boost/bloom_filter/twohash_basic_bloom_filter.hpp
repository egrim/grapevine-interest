...
template<typename T, size_t Size, size_t HashValues = 2,
        size_t ExpectedInsertionCount = 0, class HashFunction1 = boost_hash<T>,
...
public:
    ...
    typedef twohash_basic_bloom_filter<T, Size, HashValues,
...
public:
    ...
    template<class _T, size_t _Size, size_t _HashValues,
            size_t _ExpectedInsertionCount, class _HashFunction1,
            class _HashFunction2, class _ExtensionFunction>
    friend bool
    operator==(
            const twohash_basic_bloom_filter<_T, _Size, _HashValues,
...
bool operator==(
        const twohash_basic_bloom_filter<T, Size, HashValues,
                ExpectedInsertionCount, HashFunction1, HashFunction2,
...
template<class T, size_t Size, size_t HashValues, size_t ExpectedInsertionCount,
        class HashFunction1, class HashFunction2, class ExtensionFunction>
twohash_basic_bloom_filter<T, Size, HashValues, ExpectedInsertionCount,
        HashFunction1, HashFunction2, ExtensionFunction> operator|(
        const twohash_basic_bloom_filter<T, Size, HashValues,
                ExpectedInsertionCount, HashFunction1, HashFunction2,
                ExtensionFunction>& lhs
        ,
        const twohash_basic_bloom_filter<T, Size, HashValues,
                ...
                ExtensionFunction>& rhs) {
    twohash_basic_bloom_filter<T, Size, HashValues, ExpectedInsertionCount,
            HashFunction1, HashFunction2, ExtensionFunction> result(lhs);
...
void swap(
        twohash_basic_bloom_filter<T, Size, HashValues, ExpectedInsertionCount,
                HashFunction1, HashFunction2, ExtensionFunction>& lhs
        ,
        twohash_basic_bloom_filter<T, Size, HashValues, ExpectedInsertionCount,
                HashFunction1, HashFunction2, ExtensionFunction>& rhs) {
    lhs.swap(rhs);
}
} // namespace bloom_filters
} // namespace boost
