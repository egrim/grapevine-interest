...
template<typename T, size_t HashValues = 2, size_t ExpectedInsertionCount = 0,
        class HashFunction1 = boost_hash<T>,
        class HashFunction2 = murmurhash3<T>,
        typename ExtensionFunction = detail::square, typename Block = size_t,
...
public:
    ...
    typedef twohash_dynamic_basic_bloom_filter<T, HashValues,
            ExpectedInsertionCount, HashFunction1, HashFunction2,
            ExtensionFunction, Block, Allocator> this_type;

    static const size_t default_size = 32;

private:
    typedef detail::twohash_apply_hash<HashValues, this_type> apply_hash_type;
...
public:
    ...
    template<class _T, size_t _HashValues, size_t _ExpectedInsertionCount,
            class _HashFunction1, class _HashFunction2,
            class _ExtensionFunction, typename _Block, class _Allocator>
    friend bool
    operator==(
            const twohash_dynamic_basic_bloom_filter<_T, _HashValues,
                    _ExpectedInsertionCount, _HashFunction1, _HashFunction2,
                    _ExtensionFunction, _Block, _Allocator>&
            ,
            const twohash_dynamic_basic_bloom_filter<_T, _HashValues,
                    _ExpectedInsertionCount, _HashFunction1, _HashFunction2,
                    _ExtensionFunction, _Block, _Allocator>&);
...
//* global ops
template<class T, size_t HashValues, size_t ExpectedInsertionCount,
        class HashFunction1, class HashFunction2, class ExtensionFunction,
        typename Block, class Allocator>
bool operator==(
        const twohash_dynamic_basic_bloom_filter<T, HashValues,
                ExpectedInsertionCount, HashFunction1, HashFunction2,
                ExtensionFunction, Block, Allocator>& lhs
        ,
        const twohash_dynamic_basic_bloom_filter<T, HashValues,
                ExpectedInsertionCount, HashFunction1, HashFunction2,
                ExtensionFunction, Block, Allocator>& rhs) {
...
template<class T, size_t HashValues, size_t ExpectedInsertionCount,
        class HashFunction1, class HashFunction2, class ExtensionFunction,
        typename Block, class Allocator>
twohash_dynamic_basic_bloom_filter<T, HashValues, ExpectedInsertionCount,
        HashFunction1, HashFunction2, ExtensionFunction, Block, Allocator> operator|(
        const twohash_dynamic_basic_bloom_filter<T, HashValues,
                ExpectedInsertionCount, HashFunction1, HashFunction2,
                ExtensionFunction, Block, Allocator>& lhs
        ,
        const twohash_dynamic_basic_bloom_filter<T, HashValues,
                ...
                ExtensionFunction, Block, Allocator>& rhs) {
    twohash_dynamic_basic_bloom_filter<T, HashValues, ExpectedInsertionCount,
            HashFunction1, HashFunction2, ExtensionFunction, Block, Allocator> result(
            lhs);
...
template<class T, size_t Size, size_t HashValues, size_t ExpectedInsertionCount,
        class HashFunction1, class HashFunction2, class ExtensionFunction,
        typename Block, class Allocator>
void swap(
