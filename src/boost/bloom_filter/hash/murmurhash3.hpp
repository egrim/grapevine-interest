...
struct murmurhash3 {
    typedef detail::murmurhash3_dispatch<detail::Is64Bit::value, Use128Mode> dispatch_type;
...
void murmurhash3_x86_32(const void * const key, const size_t len,
    ...
    const uint32_t * const blocks = reinterpret_cast<const uint32_t *>(data
            + nblocks * 4);
...
void murmurhash3_x86_128(const void * const key, const size_t len,
    ...
    const uint8_t * const tail =
            static_cast<const uint8_t*>(data + nblocks * 16);
...
void murmurhash3_x64_128(const void * const __restrict__ key, const size_t len,
    ...
    const uint64_t * const __restrict__ blocks =
    ...
    const uint8_t * const __restrict__ tail = static_cast<const uint8_t*>(data
            + nblocks * 16);
