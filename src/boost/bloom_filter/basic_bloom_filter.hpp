...
template<typename T, size_t Size, class HashFunctions = mpl::vector<
        boost_hash<T> > >
...
public:
    ...
    typedef basic_bloom_filter<T, Size, HashFunctions> this_type;
...
template<class _T, size_t _Size, class _HashFunctions>
bool operator==(const basic_bloom_filter<_T, _Size, _HashFunctions>& lhs,
...
template<class _T, size_t _Size, class _HashFunctions>
basic_bloom_filter<_T, _Size, _HashFunctions> operator|(
        const basic_bloom_filter<_T, _Size, _HashFunctions>& lhs,
        const basic_bloom_filter<_T, _Size, _HashFunctions>& rhs) {
...
template<class _T, size_t _Size, class _HashFunctions>
void swap(basic_bloom_filter<_T, _Size, _HashFunctions>& lhs,
